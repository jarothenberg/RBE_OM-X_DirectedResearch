...
switch (My_DXL)
    ...
    case {'X_SERIES','MX_SERIES'}
        ...
        DXL_MAXIMUM_POSITION_VALUE  = 1; % and this value (note that the Dynamixel would not move when the position value is out of movable range. Check e-manual about the range of the Dynamixel you use.)
        BAUDRATE                    = 1000000;
