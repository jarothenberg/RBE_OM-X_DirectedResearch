...
stretchedPos = [45 90-atan2d(24,128) atan2d(24,128)-90 0];
homePos = [0 0 0 0];
...
dataManip = dataManip(1:count-1,:);
dataEePos = dataEePos(1:count-1,:);

% Save data to a file
data = struct("time", dataTime, "eePoses", dataEePos, "manip", dataManip);
save("lab4_signoff3_data.mat", "data");